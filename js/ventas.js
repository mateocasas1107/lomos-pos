 ...
 * control sanitario multi-lote por fecha de caducidad (FIFO) y Tarifa de Precio Editable.
 */
...
export function renderVentas(container, state) {
    ...
    if (state.tipoPrecioActivo === undefined) state.tipoPrecioActivo = "detal"; // 'detal', 'mayor' o 'alto'
    ...
    window.agregarAlCarrito = (id) => {
        ...
        if (state.tipoPrecioActivo === 'mayor') {
            ...
            // NUEVO: Leer el valor del input editable en la tarjeta
            ...
            <table style="width: 100%; border-collapse: collapse; margin-bottom: 30px; font-size: 14px;">
                <thead>
                    <tr style="border-bottom: 2px solid #000;">
                        <th style="padding: 10px; text-align: left; color: #f4f4f4; font-weight: 800;">Descripción de Artículo</th>
                        <th style="padding: 10px; text-align: center; color: #f4f4f4; font-weight: 800;">Cant / Peso</th>
                        <th style="padding: 10px; text-align: right; color: #f4f4f4; font-weight: 800;">Precio Unit.</th>
                        <th style="padding: 10px; text-align: right; color: #f4f4f4; font-weight: 800;">Valor Total</th>
                    </tr>
                </thead>
                <tbody>
                    ${venta.items.map(i => {
        ...
        <div class="module-fade-in">
            ...
            <div class="pos-layout">
                <div class="product-grid">
                    ${productosFiltrados.length > 0 ? productosFiltrados.map(p => {
                        ...
                        <div class="card" style="position: relative; ${visualStyles}">
                            ...
                            <!-- NUEVO: Input condicional para editar el precio -->
                ...
                <div class="cart-summary" style="background: #141414; color: #ffffff; padding: 25px; border-radius: 12px; border: 1px solid #2a2a2a; box-shadow: 0 5px 15px rgba(0,0,0,0.5); position: sticky; top: 15px; max-height: 90vh; overflow-y: auto; display: flex; flex-direction: column;">
                    ...
                    <div class="cart-items" style="border-bottom: 2px dashed #333; padding-bottom: 15px; margin-bottom: 15px; overflow-y: auto; max-height: 35vh; flex-shrink: 0;">
