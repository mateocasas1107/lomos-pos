            ...
            <table style="width: 100%; border-collapse: collapse; margin-bottom: 30px; font-size: 14px;">
                <thead>
                    <tr style="border-bottom: 2px solid #000;">
                        <th style="padding: 10px; text-align: left; color: #000; font-weight: 800;">Descripción de Artículo</th>
                        <th style="padding: 10px; text-align: center; color: #000; font-weight: 800;">Cant / Peso</th>
                        <th style="padding: 10px; text-align: right; color: #000; font-weight: 800;">Precio Unit.</th>
                        <th style="padding: 10px; text-align: right; color: #000; font-weight: 800;">Valor Total</th>
                    </tr>
                </thead>
                <tbody>
                    ${venta.items.map(i => {
